...
def obtenerMatrizMascaras(groundt,ignorarZonaGris):
    ...
    while j < N:
         #Los objetos del groundtruth con class_id=10 representan puntos ciegos
         #para mostrar el groundtruth puede estar bien guardar su mascara, no para las metricas
         #if not ignorarZonaGris or (ignorarZonaGris and groundt[i].class_id!=10):
