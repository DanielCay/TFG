...
4) Ejecuta la celda de dicha función (tras haber ejecutado todas las celdas anteriores) pasándole como parámetro el nombre de tu video ("procesarFrame(prueba.mp4)")
